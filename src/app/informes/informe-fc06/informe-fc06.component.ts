...
@Component({
  selector: 'app-informe-fc06',
  templateUrl: './informe-fc06.component.html'
})
export class InformeFc06Component implements OnInit {
  ...
  public list_saldo_anterior:string[]=[];
  ...
  generarInformeF05(){
    ...
    this.apiService.getAllfc06Items(this.yearSelect).pipe(
      pluck('data')
      ).subscribe(data => {
        ...
        const subcuenta: { columns: ({ text: string,fontSize:7 })[][]; }[][] = [];
              ...
              columns:[
                ...
                [

                  {
                    ...
                    text: String(Math.round(Number(exp.valor_total)).toLocaleString("de-DE")),fontSize:7
                  }
                ]
              ...
              columns:[
                ...
                [

                  {
                    ...
                    text: String(Math.round(exp.valor_total).toLocaleString("de-DE")),fontSize:7
                  }
                ]
        ...
        this.apiService.getAllfc06ItemSum(this.yearSelect).pipe(
          pluck('data')
          ).subscribe(data => {
            ...
            content: [
              [{
                ...
                height: 60,
                  ...
                  , [{text: ' EJERCICIO  '+this.yearSelect, style: 'subheader',alignment: 'center'}],
                  , [,{text: '', style: 'header',alignment: 'right',fontSize:8},{text: `                                                                                                                                                                           Hoja Nº. : 1`, style: 'header',alignment: 'right',fontSize:7}],
                , [,{text: '', style: 'header',alignment: 'right',fontSize:8},
                {text: 'Niv. Entidad: 23  ENTES AUTONOMOS Y AUTARQUICOS',style: 'header',alignment: 'left',fontSize:7},
                {text: 'Entidad: 18  SERVICIO NACIONAL DE CALIDAD Y SANIDAD VEGETAL Y DE SEMILLAS',style: 'header',alignment: 'left',fontSize:7},
                {text: 'Unidad Jerarq: 1000000 SENAVE',style: 'header',alignment: 'left',fontSize:7},
                {text: 'Unidad Resp.: 1 SERVICIO NACIONAL DE CALIDAD Y SANIDAD VEGETAL Y DE SEMILLAS',style: 'header',alignment: 'left',fontSize:7}],
              {
                style: 'tableExample',
                table: {
                  body: [
                    [
                      ...
                      {}],
                      [{text: 'SUB-CUENTA', style: 'header',alignment: 'center',fontSize:7,colSpan: 3},
                      {}],
                      [{text: 'DESCRIPCION', style: 'header',alignment: 'center',fontSize:7,colSpan: 4},
                      {},{},{}],
                      [{text: 'VALOR PARCIAL', style: 'header',alignment: 'center',fontSize:7}],

                      [{text: 'VALOR TOTAL', style: 'header',alignment: 'center',fontSize:7}],

                    ],



                    [cuenta,subcuenta,nombre_cuenta,saldo_anterior,total],
                    [{ text: 'TOTAL', fontSize: 9, alignment: 'right',colSpan: 3},{},{},{},{text: Math.round(this.totalGeneral).toLocaleString("de-DE"), fontSize: 9, alignment: 'center'}],
                  ]
                }
                ...
                body: [
                  [
                    ...
                    */
                    ...
                    [{ text: '  Jefe de Patrimonio de la entidad(11)  ', fontSize: 8,decoration: 'overline',margin: [5, 45, 0, 0] }],
              ...
              table: {
                body: [
                  [
                    ...
                    [{ text: '  Director Gral. de Administración y Finanzas(12)  ', fontSize: 8,decoration: 'overline',margin: [390, -20, 0, 0] }],
